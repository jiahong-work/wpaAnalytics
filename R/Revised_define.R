#' View the percent of population covered by different net score cutoffs, and display the net score histogram
#'
#' @param .df Data frame that contains all the modeling scores
#' @param .us Model score that leans towards our standpoint 
#' @param .them Model score that leans against our standpoint
#' @param .bins Number of bins you want to show in the histogram
#'
#' @return A tibble in the console displaying the percent of population covered by different net score cutoffs,
#'         and a histogram showing the distribution of the net score
#' @export
#'
